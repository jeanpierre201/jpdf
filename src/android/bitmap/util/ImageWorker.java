...
public abstract class ImageWorker {
     ...
     *
     * @param data The Uri of the image to download.
     * @param mImageView The ImageView to bind the downloaded image to.
     */
    public void loadImage(Object data, ImageView mImageView) {
        if (data == null) {
            return;
        }
        ...
        } else if (cancelPotentialWork(data, mImageView)) {
