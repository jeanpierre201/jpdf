...
import industriekatalog.app.BillingService.RequestPurchase;
import industriekatalog.app.BillingService.RestoreTransactions;
import industriekatalog.app.Consts.PurchaseState;
import industriekatalog.app.Consts.ResponseCode;
...
public class Dungeons extends Activity implements OnClickListener,
    ...
    public class CatalogEntry {
        ...
        public CatalogEntry(String sku, String nameId, Managed managed) {
            this.sku = sku;
            this.nameId = nameId;
	...
	public static void addToCatalog(String title2, String order_num2) {
		title = title2;
 ...
 //     new CatalogEntry("androidwelt_2859", "String", Managed.MANAGED),
      new CatalogEntry(title, order_num, Managed.UNMANAGED),
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_billing);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        mItemName = (CATALOG[position].nameId);
