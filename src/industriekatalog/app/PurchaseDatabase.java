...
public class PurchaseDatabase {
    ...
    public PurchaseDatabase close() {
        mDatabaseHelper.close();
        return this;
    }
    
    public PurchaseDatabase open() throws SQLException {
    	mDatabaseHelper = new DatabaseHelper(context);
        mDb = mDatabaseHelper.getWritableDatabase();
		return this;
	}
     ...
     *     the order.
     */
    public void insertOrder(String orderId, String productId, PurchaseState state,
